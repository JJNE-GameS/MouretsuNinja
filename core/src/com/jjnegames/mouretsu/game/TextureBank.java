...
public class TextureBank extends AssetManager{
	...
	public static Texture pl_atk1 = new Texture(Gdx.files.internal("alus.png"));
	public static Texture pl_atk2 = new Texture(Gdx.files.internal("alus.png"));
	public static Texture pl_atk3 = new Texture(Gdx.files.internal("alus.png"));
	public static Texture pl_atk4 = new Texture(Gdx.files.internal("alus.png"));
	public static Texture pl_atk5 = new Texture(Gdx.files.internal("alus.png"));
	public static Texture pl_atk6 = new Texture(Gdx.files.internal("alus.png"));
	public static Texture pl_atk7 = new Texture(Gdx.files.internal("alus.png"));
	public static Texture pl_atk8 = new Texture(Gdx.files.internal("alus.png"));
	public static Texture pl_atk9 = new Texture(Gdx.files.internal("alus.png"));
	public static Texture pl_atk10 = new Texture(Gdx.files.internal("alus.png"));
