...
public class Juggernaut extends Char	{
	...
	public Juggernaut(Body body, Texture texture, float width, float height) {
		super(body,texture);
	...
	public static Juggernaut create(World world, BodyDef bodyDef, float w, float h,Texture texture
...
//	        atklb.getMassData().I=0;
			...
			Juggernaut e = new Juggernaut(body, texture, w, h);
		    body.setUserData(e);
		    feet.setUserData(e);
